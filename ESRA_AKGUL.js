...
.productShowcase .productCard .productInfo {
  padding: 0 10px;
  margin: 8px 0 6px 0;
  color: #2B2F33;
  font-size: 12px;
...
.productShowcase .productCard .productInfo strong {
  font-weight: 600;
  color: #2B2F33;
}

.productCard .productInfo .description {
  font-weight: normal;
  color: #2B2F33;
  font-size: 12px;
  font-family: Quicksand-SemiBold, Quicksand, system-ui, sans-serif;
    ...
    .then((products) => {
      ...
      products.forEach((product) => {
        ...
        card.innerHTML = `
          ...
          <button class="cartBtn" aria-label="Sepete ekle"></button>
          <button class="wishlistBtn" aria-label="Favorilere ekle"></button>
        `;
...
showcase.innerHTML = `
  ...
  <button class="navBtn prev" aria-label="Önceki ürünler"></button>
  <button class="navBtn next" aria-label="Sonraki ürünler"></button>
`;
